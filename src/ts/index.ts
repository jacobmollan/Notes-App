...
const elVersion = <HTMLInputElement>document.querySelector("#version")
...
const elSubmitBtn = <HTMLInputElement>document.querySelector("#submit")
const elGrid = <HTMLInputElement>document.querySelector("#grid-test")

elSubmitBtn.addEventListener("click", (event) => {
    let elTitleInput = <HTMLInputElement>document.querySelector("#title-input")
    let elLargeInput = <HTMLInputElement>document.querySelector("#large-input")
